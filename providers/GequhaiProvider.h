...
class GequhaiProvider final : public IMusicProvider
{
    Q_OBJECT
public:
    explicit GequhaiProvider(QObject *parent = nullptr);

    QString providerId() const override { return QStringLiteral("gequhai"); }
    QString displayName() const override { return QStringLiteral("歌曲海"); }
...
private:
    ...
    QString m_baseUrl = QStringLiteral("https://www.gequhai.com");
